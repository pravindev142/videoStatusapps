...
import com.saispark.marathi_video_status.ui.Activities.AllFullScreenCategoryActivity;
import com.saispark.marathi_video_status.ui.Activities.AllFullScreenFollowActivity;
import com.saispark.marathi_video_status.ui.Activities.AllFullScreenSearchActivity;
import com.saispark.marathi_video_status.ui.Activities.AllFullScreenUserActivity;
import com.saispark.marathi_video_status.ui.Activities.AllPortaitVideosActivity;
import com.saispark.marathi_video_status.ui.Activities.GifActivity;
import com.saispark.marathi_video_status.ui.Activities.ImageActivity;
import com.saispark.marathi_video_status.ui.Activities.PlayerActivity;
import com.saispark.marathi_video_status.ui.Activities.QuoteActivity;
...
import com.saispark.marathi_video_status.ui.Activities.YoutubeActivity;
import com.saispark.marathi_video_status.ui.view.ClickableViewPager;
...
//            Log.v("this is path",statusList.get(position).getPath());
    ...
    class DownloadFileFromURL extends AsyncTask<Object, String, String> {
        ...
        public void AddDownloadLocal(Integer position){
            final DownloadStorage downloadStorage= new DownloadStorage(activity.getApplicationContext());
            List<com.saispark.marathi_video_status.model.Status> download_list = downloadStorage.loadImagesFavorites();
            Boolean exist = false;
            ...
            if (exist  == false) {
                ArrayList<com.saispark.marathi_video_status.model.Status> audios= new ArrayList<com.saispark.marathi_video_status.model.Status>();
                for (int i = 0; i < download_list.size(); i++) {
                    audios.add(download_list.get(i));
                }
                com.saispark.marathi_video_status.model.Status videodownloaded = statusList.get(position);
