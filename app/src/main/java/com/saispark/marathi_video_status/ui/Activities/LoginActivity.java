...
public class LoginActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Code written by me to send user on privacy policy page
        text_view_login_activity_privacy = findViewById(R.id.text_view_login_activity_privacy);
        text_view_login_activity_privacy.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    // code written by me for privacy policy
